    ...
    <div className="bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 py-12 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-8 overflow-hidden">
          <div className={`bg-gradient-to-r ${result.color || 'from-pink-500 to-purple-600'} p-8 text-white text-center`}>
          ...
          <div className="p-6 bg-white">
            ...
            <div className="border rounded-lg overflow-hidden">
                <img
                  src={`/api/og?type=${result.type}&title=${encodeURIComponent(result.title)}&summary=${encodeURIComponent(result.tagline)}&emoji=${result.emoji}&bg=${result.og.bg}&testType=dessert-style`}
